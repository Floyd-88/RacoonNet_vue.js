...
class PostsDB {
    ...
    createTablePosts() {
        const sql = `CREATE TABLE IF NOT EXISTS posts (id integer PRIMARY KEY AUTO_INCREMENT, name varchar(30), surname varchar(30), date varchar(50), postText text, userID integer, 
