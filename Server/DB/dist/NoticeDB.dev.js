...
function () {
  ...
  _createClass(NoticeDB, [{
    ...
    value: function add_notice_DB(params, callback) {
      return this.connection.execute("INSERT INTO notice\n        (user_id_addressee, user_id_sender, user_comments_comment_addressee, text_notice, post_id, photo_id, comment_post_id, comment_comments_post_id, comment_photo_id, friend_id, date) VALUES (?,?,?,?,?,?,?,?,?,?,?)", params, function (err, row_notice) {
